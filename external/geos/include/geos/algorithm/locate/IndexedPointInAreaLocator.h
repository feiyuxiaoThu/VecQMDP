...
public:
    ...
    /** \brief
     * Collects all segments that intersect with a horizontal ray at a given y-coordinate.
     *
     * @param x the x-coordinate of the point
     * @param y the y-coordinate of the point
     * @return a vector of SegmentView objects
     */
    std::vector<SegmentView> collectSegments(const double x, const double y);
